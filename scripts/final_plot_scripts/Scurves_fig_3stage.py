...
def main():
    ...
    s1.text(-0.1, 1.05, '(a)', transform=s1.transAxes, fontsize=16, va='bottom', ha='right')
    s0.text(-0.1, 1.05, '(b)', transform=s0.transAxes, fontsize=16, va='bottom', ha='right')
    sind.text(-0.1, 1.05, '(c)', transform=sind.transAxes, fontsize=16, va='bottom', ha='right')
    eig1.text(-0.1, 1.05, '(d)', transform=eig1.axs[0].transAxes, fontsize=16, va='bottom', ha='right')
