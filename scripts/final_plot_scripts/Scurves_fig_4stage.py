...
def onerun_eigs_rho(rho, S, C, Bseed, delta):
    ...
    R = lvf.R_star_4stage_delta(B, delta)
...
def main():
    ...
    rho_dir = os.path.join(current_dir, '..', '..', 'data', 'S_curves', '4stage', 'B_rho')
    ind_dir = os.path.join(current_dir, '..', '..', 'data', 'S_curves', '4stage', 'B_ind')
    ...
    Bind_files = ['B_L3_ind_S25_500rpk.npz', 'B_L3_ind_S100_500rpk.npz', 'B_L3_ind_S100_500rpk.npz']
    ...
    rho1text = r'4 stages, $B_{\rho}$, $\rho=1$'+f' \nS = {S}, C = {C}, K = {K1:.1f}'
    rho0text = r'4 stages, $B_{\rho}$, $\rho=0$'+f' \nS = {S}, C = {C}, K = {K0:.1f}'
    indtext = r'4 stages, $B_{ind}$'+f' \nS = {S}, C = {C}, K = {Kind:.1f}'
    eigcol = 'olivedrab'
